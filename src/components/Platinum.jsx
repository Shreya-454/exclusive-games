...
import platinum1 from '../assets/images/platinum1.webp'
const Platinum = () => {
  return (
    <div  className="px-4 xl:px-0">
      <div className="px-4 xl:px-0 mx-auto bg-light-gradient border-[0.5px]  border-solid border-[#FFFFFF80] rounded-2xl relative z-[1]" data-aos="zoom-in-down" data-aos-duration="1000">
        <div className="w-[162px] h-[162px] rounded-full bg-ellipse blur-[40px] absolute z-[-1] right-[12%] top-[13%]"></div>
        <div className="flex flex-wrap lg:flex-row flex-col-reverse">
          <div className="lg:w-5/12 w-full  xl:pl-[50px] lg:py-[120px] pb-5 flex justify-center">
            <div>
              <h3 className="text-white font-anton text-2xl  md:text-[32px] !leading-[41.6px] font-normal mb-4 text-center lg:text-start">
                Platinum
              </h3>
                <p className=" font-inter text-white text-sm md:text-base font-medium !leading-[25.6px] opacity-80 mb-8 max-w-[364px] text-center lg:text-start mx-auto">
              ...
              <div className="flex gap-2 lg:mb-10 mb-5 justify-center lg:justify-normal">
                <span>
                  <svg
                    width="24"
                    height="24"
                ...
                <span className="text-sm md:text-base text-white font-inter font-medium opacity-80 !leading-[25.6px] ">
                  Personalizable{" "}
                </span>
              </div>
          ...
          <div className="lg:w-7/12 w-full pt-5  lg:py-[78px] xl:pr-10 xl:pl-0">
            <img src={platinum1} alt="img" className="w-full" />
          </div>
        </div>
      </div>
    </div>
