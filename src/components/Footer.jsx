...
const Footer = () => {
  ...
  return (
    <div className="bg-[#000000] md:pb-5 pb-8 pt-10 relative overflow-hidden">
    <div className="max-w-[1140px] px-3 mx-auto">
        <div className="flex flex-row flex-wrap -mx-3 pb-12">
            <div className="xl:w-5/12 px-3 w-full pt-7">
                ...
                <p className="text-[#cccccc] text-sm md:text-base font-inter !leading-[25px] max-w-[369px] pt-4 font-medium">
            ...
            <div className="xl:w-7/12 px-3 pt-7 md:pt-10 w-full">
                <div className="flex flex-row flex-wrap -mx-3">
                    <div className="md:w-4/12 w-1/2 px-3">
                        <ul>
                            <li className="text-[#ffffff] text-sm md:text-base font-inter !leading-[25px] lg:max-w-[369px] font-bold pb-4 ">
                                Menú principal
                            </li>
                            <li className="pb-3 ">
                                <a href="" className="text-[#cccccc] text-sm md:text-base font-inter !leading-[25px] lg:max-w-[369px] font-medium  hover:text-[#ffff] transition-all duration-500 " > Hogar
                                </a>
                            </li>
                            <li className="pb-3 ">
                                <a href="" className="text-[#cccccc] text-sm md:text-base font-inter !leading-[25px] lg:max-w-[369px]  font-medium  hover:text-[#ffff] transition-all duration-500 "
                                >
                                    Misión
                                </a>
                            </li>
                            <li className="pb-3">
                                <a
                                    href=""
                                    className="text-[#cccccc] text-sm md:text-base font-inter !leading-[25px] lg:max-w-[369px] font-medium hover:text-[#ffff] transition-all duration-500"
                                >
                                    Tragamonedas
                                </a>
                            </li>
                    ...
                    <div className="md:w-4/12 w-1/2 px-3 pt-8 md:pt-0">
                        <ul>
                            ...
                            <li className="flex gap-2 items-center pb-3">
                                ...
                                <a href="" className="text-[#cccccc] text-sm md:text-base font-inter !leading-[25px] hover:text-[#ffff] transition-all duration-500">juegosexclusivos@gmail.com</a>
                            </li>
                            <li className="flex gap-2 items-center pb-3">
                                <span>
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a href="" className="text-[#cccccc] text-sm md:text-base font-inter !leading-[25px] hover:text-[#ffff] transition-all duration-500">(101)342-7873</a>
                            </li>
                        </ul>
                    </div>
    ...
    <p className=" text-center text-[#808080] text-sm md:text-base font-inter !leading-[25px] pt-5" >
        © Juegos exclusivos - Todos los derechos reservados {year}
    </p>
    <div className="absolute  bottom-[-2%] bg-ellipse blur-[79px] w-[170px] h-[170px] opacity-50% left-[-7%] hidden lg:block"></div>
    <div className="w-[180px] h-[180px] bg-ellipse blur-[79px] opacity-50 absolute top-[25%] right-[-8%] hidden lg:block"></div>
</div>
  );
};
